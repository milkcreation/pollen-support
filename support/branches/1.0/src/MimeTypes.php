...
class MimeTypes extends BaseMimeTypes
{
     ...
     * @return array[]
     */
    public static function getBuiltInMapping(array $terms, bool $allowed = false): array
    {
        $extensions = [];
        $mimes = [];
                ...
                foreach ($mimeTypes as $mimeType) {
                    if (!isset($extensions[$mimeType])) {
                        ...
                        foreach ($exts as $ext) {
                            ...
                            if (!in_array($mimeType, $mimes[$ext], true)) {
                                $mimes[$ext][] = $mimeType;
                            }
                        }
                    }
    ...
    public static function inType(string $filename, $type = null): bool
    {
        ...
        if ($ext = pathinfo($filename, PATHINFO_EXTENSION)) {
            return (bool)(new self($mapping))->getMimeType($ext);
        }
     ...
     *
     * @param string|null $entity extensions|mimes
     *
     * @return array
     */
